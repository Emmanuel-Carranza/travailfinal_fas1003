...
subtitle: "Données venant de Data is Beautiful"  
author: 
  - "Emmanuel Carranza"
date: '`r Sys.Date()`'
output:
...
- Category: ils y a 10 différentes catégories

- Value : la valeurs du temps utilisé pour décoder

- Time unit: l'unité de mesure du temps (seconde, heure, jour, mois, année)

- Strength : La force du mot de passe 0 étant le moins fort allant jusqu'a

---
# Ce qui rend la clef sécuritaire

##- Catégorie (significatif/dictionnaire vs fictif)
...
- En moyenne on y retrouve 6 caractère
